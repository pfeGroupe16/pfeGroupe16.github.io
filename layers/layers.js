...
lyr_routes_0.setVisible(true);lyr_edicifes_1.setVisible(true);lyr_bornes_geodesiques_2.setVisible(true);lyr_communes_3.setVisible(true);lyr_cours_eaux_4.setVisible(true);
...
lyr_bornes_geodesiques_2.set('fieldImages', {'id_borne': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'h': 'TextEdit', 'type_borne': 'TextEdit', 'Reseau_geo': 'TextEdit', 'lat': 'Hidden', 'long': 'Hidden', });
...
lyr_routes_0.set('fieldLabels', {'type_route': 'inline label', 'id_route': 'inline label', });
lyr_edicifes_1.set('fieldLabels', {'id_edifice': 'inline label', 'type_edifi': 'inline label', });
lyr_bornes_geodesiques_2.set('fieldLabels', {'id_borne': 'inline label', 'X': 'inline label', 'Y': 'inline label', 'h': 'inline label', 'type_borne': 'inline label', 'Reseau_geo': 'inline label', });
lyr_communes_3.set('fieldLabels', {'Nom_commun': 'inline label', 'id_commune': 'inline label', 'sup_commun': 'inline label', });
lyr_cours_eaux_4.set('fieldLabels', {'id_eau': 'inline label', 'type_eau': 'inline label', });
